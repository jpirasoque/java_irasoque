...
public Principal() {
    ...
    labelAMaterno.setBounds(25,308,108,25);
    ...
    labelfooter = new JLabel("02017 The Coca-Cola Company|Todos los derechos reservados");
...
public void actionPerformed(ActionEvent e){
    if(e.getSource() == miCalculo){
       ...
       if(Departamento.equals("Atencion al Cliente")){sueldo = 95.000;

                       if(Antiguedad.equals("1 año de servicio")){
                              textarea1.setText("\n El trabajador "+ nombreTrabajador +" " + AP+""+AM+
                                                "\n quien labora en " + Departamento + " con " + Antiguedad +
                                                "\n recibe 6 dias de vacaciones" + " y un bono de :" + sueldo *0.15);
      }
...
if(Departamento.equals("Departamento de Gerencia")){
              ...
              if (e.getSource() == miElCreador){
                 ...
                 JOptionPane.showMessageDialog(null,"Desarrollado por (Jessica Irasoque)\n"+
                                                    "      www.programadores.com/thebestoftheuniverse");
               }
}
